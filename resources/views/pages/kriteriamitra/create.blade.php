...
@section('title', 'Tambah Kriteria Mitra - SIM Kerjasama UIS')

@section('content')
<div class="pagetitle mb-3">
  <h1>Tambah Kriteria Mitra</h1>
  <nav>
    <ol class="breadcrumb">
...
<section class="section">
  <div class="row">
    <div class="col-12">
      ...
      <form action="{{ route('kriteria-mitra.store') }}" method="POST">
        @csrf
