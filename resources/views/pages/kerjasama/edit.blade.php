...
@section('title', 'Edit Kerjasama - SIM Kerjasama UIS')
          ...
          <div class="card-body px-4 py-4">
            ...
            <div class="row mb-4">
              <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input type="text" name="nomor_dokumen_kerjasama" id="nomor_dokumen_kerjasama" class="form-control form-control-m" placeholder="Masukkan Nomor Dokumen Kerjasama" required value="{{ old('nomor_dokumen_kerjasama', $kerjasama->nomor_dokumen_kerjasama) }}">
              </div>
              <div class="col-md-6">
                <label for="nomor_dokumen_mitra" class="form-label fw-semibold">Nomor Dokumen Mitra</label>
                <input type="text" name="nomor_dokumen_mitra" id="nomor_dokumen_mitra" class="form-control form-control-m" placeholder="Masukkan Nomor Dokumen Mitra (opsional)" value="{{ old('nomor_dokumen_mitra', $kerjasama->nomor_dokumen_mitra) }}">
              </div>
            </div>
            ...
            <div class="mb-4">
              ...
              <select name="jenis_dokumen_id" id="jenis_dokumen_id" class="form-select form-control-m" required>
                ...
                @foreach($jenisDokumens as $jd)
                  <option value="{{ $jd->id }}" data-nama="{{ strtolower($jd->nama_jenis_dokumen) }}" {{ old('jenis_dokumen_id', $kerjasama->jenis_dokumen_id) == $jd->id ? 'selected' : '' }}>{{ $jd->nama_jenis_dokumen }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="row mb-4">
              ...
              <div class="col-md-6">
                ...
                <select name="mitra_id" id="mitra_id" class="form-select form-control-m" required>
                  ...
                  @foreach($mitras as $m)
                    <option value="{{ $m->id }}" {{ old('mitra_id', $kerjasama->mitra_id) == $m->id ? 'selected' : '' }}>{{ $m->nama_mitra }}</option>
                  @endforeach
                </select>
              </div>
            </div>
            ...
            <div class="mb-4">
              ...
              <textarea name="judul_kerjasama" id="judul_kerjasama" class="form-control form-control-m" rows="2" placeholder="Masukkan Judul Kerjasama" required>{{ old('judul_kerjasama', $kerjasama->judul_kerjasama) }}</textarea>
            </div>
            ...
            <div class="row mb-4">
              ...
              <div class="col-md-6">
                ...
                <input type="number" name="anggaran" id="anggaran" class="form-control form-control-m" placeholder="0" value="{{ old('anggaran', $kerjasama->anggaran) }}" required>
              </div>
            </div>
            ...
            <div class="row mb-4">
              <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input type="date" name="tanggal_waktu_berlaku" id="tanggal_waktu_berlaku" class="form-control form-control-m" required value="{{ old('tanggal_waktu_berlaku', $kerjasama->tanggal_waktu_berlaku ? $kerjasama->tanggal_waktu_berlaku->format('Y-m-d') : '') }}">
              </div>
              <div class="col-md-6">
                ...
                <input type="date" name="tanggal_akhir_berlaku" id="tanggal_akhir_berlaku" class="form-control form-control-m" required value="{{ old('tanggal_akhir_berlaku', $kerjasama->tanggal_akhir_berlaku ? $kerjasama->tanggal_akhir_berlaku->format('Y-m-d') : '') }}">
              </div>
            </div>
            ...
            <div class="mb-4">
              ...
              <select name="status_kerjasama" id="status_kerjasama" class="form-select form-control-m" required>
                ...
                <option value="Aktif" {{ old('status_kerjasama', $kerjasama->status_kerjasama) == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                <option value="Tidak Aktif" {{ old('status_kerjasama', $kerjasama->status_kerjasama) == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                <option value="Selesai" {{ old('status_kerjasama', $kerjasama->status_kerjasama) == 'Selesai' ? 'selected' : '' }}>Selesai</option>
              </select>
            </div>
            ...
            <div class="mb-4">
              ...
              @if(!empty($kerjasama->url_file) && count($kerjasama->url_file) > 0)
                <div class="mb-3">
                  <span class="form-label d-block small text-muted fw-semibold mb-2">File Saat Ini:</span>
                  <div class="d-flex flex-column gap-2" id="existing-files-container">
                    @foreach($kerjasama->url_file as $idx => $filePath)
                      <div class="d-flex align-items-center justify-content-between p-2 px-3 bg-white border rounded-3 shadow-sm existing-file-item">
                        <input type="hidden" name="existing_files[]" value="{{ $filePath }}">
                        <div class="d-flex align-items-center gap-3 overflow-hidden me-2">
                          <i class="bi {{ Str::endsWith(strtolower($filePath), '.pdf') ? 'bi-file-earmark-pdf text-danger' : 'bi-file-earmark-word text-primary' }}" style="font-size: 1.5rem;"></i>
                          <div class="text-truncate">
                            <a href="{{ asset('storage/' . $filePath) }}" target="_blank" class="fw-semibold text-dark small text-decoration-none text-truncate d-block" title="{{ basename($filePath) }}">
                              {{ basename($filePath) }} <i class="bi bi-box-arrow-up-right ms-1 text-muted" style="font-size: 0.75rem;"></i>
                            </a>
                          </div>
                        </div>
                        <button type="button" class="btn btn-sm btn-outline-danger border-0 rounded-circle d-flex align-items-center justify-content-center p-1" style="width: 28px; height: 28px;" onclick="this.closest('.existing-file-item').remove()" title="Hapus File Ini">
              ...
              <div class="border rounded-3 p-4 text-center bg-light" style="border: 2px dashed #ced4da !important; cursor: pointer;" onclick="document.getElementById('dokumen_files').click();">
                ...
                <p class="mb-1 small fw-semibold mt-2">Klik untuk tambah file atau seret file ke sini</p>
            ...
            <div class="mb-2">
              ...
              <textarea name="hasil_pelaksanaan" id="hasil_pelaksanaan" class="form-control form-control-m" rows="3" placeholder="Masukkan Hasil Pelaksanaan (Output & Outcome) (opsional)">{{ old('hasil_pelaksanaan', $kerjasama->hasil_pelaksanaan) }}</textarea>
            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
          ...
          <div class="card-body px-4 py-4">
            ...
            <div class="mb-4">
              ...
              <textarea name="pihak[1][alamat]" id="pihak1_alamat" class="form-control form-control-m" rows="2" placeholder="Masukkan Alamat (opsional)">{{ old('pihak.1.alamat', $pihak1 ? $pihak1->alamat : '') }}</textarea>
            </div>
            ...
            <div id="pj1-wrapper">
              ...
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="1" data-index="{{ $i }}">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <select name="pihak[1][penanggung_jawab][{{ $i }}][nama]" class="form-select form-control-m select-pj-nama" required>
                      <option value=""></option>
                      @foreach($staffList as $st)
                        <option value="{{ $st->nama_staff }}" data-nup="{{ $st->nup }}" data-jabatan="{{ $st->jabatan }}" data-email="{{ $st->email }}" data-hp="{{ $st->nomor_hp }}" data-alamat="{{ $st->alamat }}" {{ old('pihak.1.penanggung_jawab.'.$i.'.nama', $pj->nama) == $st->nama_staff ? 'selected' : '' }}>
                ...
                <div class="row">
                  <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <input type="text" name="pihak[1][penanggung_jawab][{{ $i }}][jabatan]" class="form-control form-control-m" placeholder="Masukkan Jabatan (opsional)" value="{{ old('pihak.1.penanggung_jawab.'.$i.'.jabatan', $pj->jabatan) }}">
                  </div>
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Email</label>
                    <input type="email" name="pihak[1][penanggung_jawab][{{ $i }}][email]" class="form-control form-control-m" placeholder="Masukkan Email (opsional)" value="{{ old('pihak.1.penanggung_jawab.'.$i.'.email', $pj->email) }}">
                  </div>
                  <div class="col-md-4">
                    <label class="small text-muted mb-1 d-block">Nomor Telepon</label>
                    <input type="text" name="pihak[1][penanggung_jawab][{{ $i }}][nomor_hp]" class="form-control form-control-m" placeholder="Masukkan Nomor Telepon (opsional)" value="{{ old('pihak.1.penanggung_jawab.'.$i.'.nomor_hp', $pj->nomor_hp) }}">
                  </div>
                </div>
              </div>
              @empty
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="1" data-index="0">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <select name="pihak[1][penanggung_jawab][0][nama]" class="form-select form-control-m select-pj-nama" required>
                      <option value=""></option>
                      @foreach($staffList as $st)
                        <option value="{{ $st->nama_staff }}" data-nup="{{ $st->nup }}" data-jabatan="{{ $st->jabatan }}" data-email="{{ $st->email }}" data-hp="{{ $st->nomor_hp }}" data-alamat="{{ $st->alamat }}">
                          {{ $st->nama_staff }} @if($st->nup)({{ $st->nup }})@endif
                        </option>
                      @endforeach
                    </select>
                ...
                <div class="row">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Jabatan</label>
                    <input type="text" name="pihak[1][penanggung_jawab][0][jabatan]" class="form-control form-control-m" placeholder="Masukkan Jabatan (opsional)">
                  </div>
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Email</label>
                    <input type="email" name="pihak[1][penanggung_jawab][0][email]" class="form-control form-control-m" placeholder="Masukkan Email (opsional)">
                  </div>
                  <div class="col-md-4">
                    <label class="small text-muted mb-1 d-block">Nomor Telepon</label>
                    <input type="text" name="pihak[1][penanggung_jawab][0][nomor_hp]" class="form-control form-control-m" placeholder="Masukkan Nomor Telepon (opsional)">
                  </div>
                </div>
              </div>
              @endforelse
        ...
        <div class="card shadow-sm border-0 mb-4">
          ...
          <div class="card-body px-4 py-4">
            ...
            <div class="mb-4">
              ...
              <textarea name="pihak[2][alamat]" id="pihak2_alamat" class="form-control form-control-m" rows="2" placeholder="Masukkan Alamat (opsional)">{{ old('pihak.2.alamat', $pihak2 ? $pihak2->alamat : '') }}</textarea>
            </div>
            ...
            <div id="pj2-wrapper">
              ...
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="2" data-index="{{ $i }}">
                ...
                <div class="row">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Jabatan</label>
                    <input type="text" name="pihak[2][penanggung_jawab][{{ $i }}][jabatan]" class="form-control form-control-m" placeholder="Masukkan Jabatan (opsional)" value="{{ old('pihak.2.penanggung_jawab.'.$i.'.jabatan', $pj->jabatan) }}">
                  </div>
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Email</label>
                    <input type="email" name="pihak[2][penanggung_jawab][{{ $i }}][email]" class="form-control form-control-m" placeholder="Masukkan Email (opsional)" value="{{ old('pihak.2.penanggung_jawab.'.$i.'.email', $pj->email) }}">
                  </div>
                  <div class="col-md-4">
                    <label class="small text-muted mb-1 d-block">Nomor Telepon</label>
                    <input type="text" name="pihak[2][penanggung_jawab][{{ $i }}][nomor_hp]" class="form-control form-control-m" placeholder="Masukkan Nomor Telepon (opsional)" value="{{ old('pihak.2.penanggung_jawab.'.$i.'.nomor_hp', $pj->nomor_hp) }}">
                  </div>
                </div>
              </div>
              @empty
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="2" data-index="0">
                ...
                <div class="row">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Jabatan</label>
                    <input type="text" name="pihak[2][penanggung_jawab][0][jabatan]" class="form-control form-control-m" placeholder="Masukkan Jabatan (opsional)">
                  </div>
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Email</label>
                    <input type="email" name="pihak[2][penanggung_jawab][0][email]" class="form-control form-control-m" placeholder="Masukkan Email (opsional)">
                  </div>
                  <div class="col-md-4">
                    <label class="small text-muted mb-1 d-block">Nomor Telepon</label>
                    <input type="text" name="pihak[2][penanggung_jawab][0][nomor_hp]" class="form-control form-control-m" placeholder="Masukkan Nomor Telepon (opsional)">
                  </div>
                </div>
              </div>
              @endforelse
...
<script>
  ...
  let pj1Count = {{ count($pj1List) > 0 ? count($pj1List) : 1 }};
  ...
  let pj2Count = {{ count($pj2List) > 0 ? count($pj2List) : 1 }};
