          ...
          <div class="card-body px-4 py-4">
            ...
            <div class="mb-4">
              ...
              <select name="kerjasama_id" id="kerjasama_id" class="form-select form-control-m" required>
                <option value="" disabled selected>Pilih Induk Kerjasama</option>
                @foreach($kerjasamas as $k)
                  <option value="{{ $k->id }}" {{ old('kerjasama_id') == $k->id ? 'selected' : '' }}>{{ $k->judul_kerjasama }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="row mb-4">
              <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input type="text" name="nomor_dokumen_kegiatan" id="nomor_dokumen_kegiatan" class="form-control form-control-m" placeholder="Masukkan Nomor Dokumen Kegiatan (opsional)" value="{{ old('nomor_dokumen_kegiatan') }}">
              </div>
              <div class="col-md-6">
            ...
            <div class="mb-4">
              ...
              <select name="unit_kerja_id" id="unit_kerja_id" class="form-select form-control-m" required>
                <option value="" disabled selected>Pilih Unit Kerja Pengusul</option>
                @foreach($unitKerjas as $u)
                  <option value="{{ $u->id }}" {{ old('unit_kerja_id') == $u->id ? 'selected' : '' }}>{{ $u->nama_unit_kerja }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="mb-4">
              ...
              <textarea name="judul_kegiatan" id="judul_kegiatan" class="form-control form-control-m" rows="2" placeholder="Masukkan Judul Kegiatan" required>{{ old('judul_kegiatan') }}</textarea>
            </div>

            <div class="mb-4">
              <label for="mitra_name_display" class="form-label fw-semibold">Mitra</label>
              <input type="text" id="mitra_name_display" class="form-control form-control-m bg-light text-muted" readonly placeholder="Mitra otomatis terpilih setelah Induk Kerjasama dipilih">
              <input type="hidden" name="mitra_id" id="mitra_id" value="{{ old('mitra_id') }}">
            </div>
            ...
            <div class="mb-4">
              ...
              <select name="bentuk_kegiatan_id" id="bentuk_kegiatan_id" class="form-select form-control-m" required>
                ...
                @foreach($bentukKegiatans as $bk)
                  <option value="{{ $bk->id }}" {{ old('bentuk_kegiatan_id') == $bk->id ? 'selected' : '' }}>{{ $bk->nama_bentuk_kegiatan }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="mb-4">
              ...
              <select name="sasaran_kinerja_id" id="sasaran_kinerja_id" class="form-select form-control-m" required>
                <option value="" disabled selected>Pilih Sasaran Kinerja</option>
                @foreach($sasaranKinerjas as $sk)
                  <option value="{{ $sk->id }}" {{ old('sasaran_kinerja_id') == $sk->id ? 'selected' : '' }}>{{ $sk->sasaran_kinerja }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="mb-4">
              ...
              <select name="indikator_id" id="indikator_id" class="form-select form-control-m" required disabled>
                <option value="" disabled selected>Pilih Indikator Sasaran</option>
              </select>
            </div>
            ...
            <div class="row mb-4">
              <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input type="date" name="tanggal_awal_kegiatan" id="tanggal_awal_kegiatan" class="form-control form-control-m" required value="{{ old('tanggal_awal_kegiatan') }}">
              </div>
              <div class="col-md-6">
                <label for="tanggal_akhir_kegiatan" class="form-label fw-semibold">Tanggal Akhir Kegiatan <span class="text-danger">*</span></label>
                <input type="date" name="tanggal_akhir_kegiatan" id="tanggal_akhir_kegiatan" class="form-control form-control-m" required value="{{ old('tanggal_akhir_kegiatan') }}">
              </div>
            </div>

            <div class="mb-4">
              <label for="ruang_lingkup" class="form-label fw-semibold">Ruang Lingkup</label>
              <textarea name="ruang_lingkup" id="ruang_lingkup" class="form-control form-control-m" rows="2" placeholder="Masukkan Ruang Lingkup (opsional)">{{ old('ruang_lingkup') }}</textarea>
            </div>

            <div class="mb-4">
              <label for="hasil_pelakasanaan" class="form-label fw-semibold">Hasil Pelaksanaan (Output & Outcome)</label>
              <textarea name="hasil_pelakasanaan" id="hasil_pelakasanaan" class="form-control form-control-m" rows="3" placeholder="Masukkan Hasil Pelaksanaan (Output & Outcome) (opsional)">{{ old('hasil_pelakasanaan') }}</textarea>
            </div>

            <div class="mb-4">
              <label for="nilai_kontrak" class="form-label fw-semibold">Nilai Kontrak (Rp)</label>
              <input type="number" name="nilai_kontrak" id="nilai_kontrak" class="form-control form-control-m" placeholder="Masukkan Nilai Kontrak (Rp) (opsional)" value="{{ old('nilai_kontrak') }}">
            </div>

            <div class="mb-4">
              <label for="link_dokumen_kegiatan" class="form-label fw-semibold">Tautan / Link Dokumentasi Kegiatan</label>
              <input type="text" name="link_dokumen_kegiatan" id="link_dokumen_kegiatan" class="form-control form-control-m" placeholder="Masukkan Tautan / Link Dokumentasi Kegiatan (opsional)" value="{{ old('link_dokumen_kegiatan') }}">
            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
          ...
          <div class="card-body px-4 py-4">
            ...
            <div class="mb-4">
              ...
              <input type="text" name="pihak[1][penanggung_jawab]" id="pihak1_pj" class="form-control form-control-m" placeholder="Masukkan Pihak Penanggung Jawab" required value="{{ old('pihak.1.penanggung_jawab') }}">
            </div>
              ...
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="1" data-index="0">
                ...
                <div class="row">
                  <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <input type="text" name="pihak[1][penanggung_jawab_pjs][0][jabatan]" class="form-control form-control-m" placeholder="Masukkan Jabatan (opsional)" value="{{ old('pihak.1.penanggung_jawab_pjs.0.jabatan') }}">
                  </div>
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Email</label>
                    <input type="email" name="pihak[1][penanggung_jawab_pjs][0][email]" class="form-control form-control-m" placeholder="Masukkan Email (opsional)" value="{{ old('pihak.1.penanggung_jawab_pjs.0.email') }}">
                  </div>
                  <div class="col-md-4">
                    <label class="small text-muted mb-1 d-block">Nomor Telepon</label>
                    <input type="text" name="pihak[1][penanggung_jawab_pjs][0][nomor_hp]" class="form-control form-control-m" placeholder="Masukkan Nomor Telepon (opsional)" value="{{ old('pihak.1.penanggung_jawab_pjs.0.nomor_hp') }}">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
          ...
          <div class="card-body px-4 py-4">
            ...
            <div class="mb-4">
              ...
              <input type="text" name="pihak[2][penanggung_jawab]" id="pihak2_pj" class="form-control form-control-m" placeholder="Masukkan Pihak Penanggung Jawab" required value="{{ old('pihak.2.penanggung_jawab') }}">
            </div>
            ...
            <div id="pj2-wrapper">
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="2" data-index="0">
                ...
                <div class="row">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Jabatan</label>
                    <input type="text" name="pihak[2][penanggung_jawab_pjs][0][jabatan]" class="form-control form-control-m" placeholder="Masukkan Jabatan (opsional)" value="{{ old('pihak.2.penanggung_jawab_pjs.0.jabatan') }}">
                  </div>
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="small text-muted mb-1 d-block">Email</label>
                    <input type="email" name="pihak[2][penanggung_jawab_pjs][0][email]" class="form-control form-control-m" placeholder="Masukkan Email (opsional)" value="{{ old('pihak.2.penanggung_jawab_pjs.0.email') }}">
                  </div>
                  <div class="col-md-4">
                    <label class="small text-muted mb-1 d-block">Nomor Telepon</label>
                    <input type="text" name="pihak[2][penanggung_jawab_pjs][0][nomor_hp]" class="form-control form-control-m" placeholder="Masukkan Nomor Telepon (opsional)" value="{{ old('pihak.2.penanggung_jawab_pjs.0.nomor_hp') }}">
                  </div>
                </div>
              </div>
            </div>
...
<script>
  $(document).ready(function() {
    ...
    // ══ AJAX: Load Mitra dynamically based on selected Induk Kerjasama ══
    ...
    // Trigger change immediately if value is pre-selected (e.g. from validation old values)
    if ($('#kerjasama_id').val()) {
      $('#kerjasama_id').trigger('change');
    }

    // ══ AJAX: Load Indikator dynamically based on selected Sasaran Kinerja ══
    $('#sasaran_kinerja_id').on('change', function() {
      ...
      if (sasaranKinerjaId) {
        fetch(`{{ url('kegiatan/ajax/indikator-by-sasaran') }}/${sasaranKinerjaId}`)
          .then(res => res.json())
          .then(data => {
            selectIndikator.html('<option value="" disabled selected>Pilih Indikator Sasaran</option>');
            data.forEach(ind => {
        ...
        selectIndikator.html('<option value="" disabled selected>Pilih Indikator Sasaran</option>');
        selectIndikator.prop('disabled', true);
        selectIndikator.trigger('change');
      }
    });

    if ($('#sasaran_kinerja_id').val()) {
      $('#sasaran_kinerja_id').trigger('change');
    }
  });
