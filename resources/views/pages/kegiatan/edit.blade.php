              ...
              @if(!empty($kegiatan->url_file) && count($kegiatan->url_file) > 0)
                <div class="mb-3">
                  ...
                  <div class="d-flex flex-column gap-2" id="existing-files-container">
                    @foreach($kegiatan->url_file as $idx => $filePath)
            ...
            <div id="pj1-wrapper">
              ...
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="1" data-index="{{ $i }}">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <select name="pihak[1][penanggung_jawab_pjs][{{ $i }}][nama]" class="form-select form-control-m select-pj-nama" required>
                      <option value=""></option>
                      @foreach($staffList as $st)
                        <option value="{{ $st->nama_staff }}" data-nup="{{ $st->nup }}" data-jabatan="{{ $st->jabatan }}" data-email="{{ $st->email }}" data-hp="{{ $st->nomor_hp }}" data-alamat="{{ $st->alamat }}" {{ old('pihak.1.penanggung_jawab_pjs.'.$i.'.nama', $pj->nama) == $st->nama_staff ? 'selected' : '' }}>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="pihak[1][penanggung_jawab_pjs][{{ $i }}][nip]" class="form-control form-control-m" placeholder="Masukkan NUP (opsional)" value="{{ old('pihak.1.penanggung_jawab_pjs.'.$i.'.nip', $pj->nip) }}">
                  </div>
                </div>
                <div class="row">
              ...
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="1" data-index="0">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    <label class="small text-muted mb-1 d-block">NUP</label>
                    <input type="text" name="pihak[1][penanggung_jawab_pjs][0][nip]" class="form-control form-control-m" placeholder="Masukkan NUP (opsional)">
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4 mb-3 mb-md-0">
            ...
            <div id="pj2-wrapper">
              ...
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="2" data-index="{{ $i }}">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label class="small text-muted mb-1 d-block">Nama *</label>
                    <select name="pihak[2][penanggung_jawab_pjs][{{ $i }}][nama]" class="form-select form-control-m select-pj-nama" required>
                      <option value=""></option>
                      @foreach($staffList as $st)
                        <option value="{{ $st->nama_staff }}" data-nup="{{ $st->nup }}" data-jabatan="{{ $st->jabatan }}" data-email="{{ $st->email }}" data-hp="{{ $st->nomor_hp }}" data-alamat="{{ $st->alamat }}" {{ old('pihak.2.penanggung_jawab_pjs.'.$i.'.nama', $pj->nama) == $st->nama_staff ? 'selected' : '' }}>
                          {{ $st->nama_staff }} @if($st->nup)({{ $st->nup }})@endif
                        </option>
                      @endforeach
                      @if($pj->nama && !$staffList->pluck('nama_staff')->contains($pj->nama))
                  ...
                  <div class="col-md-6 mb-3">
                    <label class="small text-muted mb-1 d-block">NUP</label>
                    <input type="text" name="pihak[2][penanggung_jawab_pjs][{{ $i }}][nip]" class="form-control form-control-m" placeholder="Masukkan NUP (opsional)" value="{{ old('pihak.2.penanggung_jawab_pjs.'.$i.'.nip', $pj->nip) }}">
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4 mb-3 mb-md-0">
              ...
              <div class="pj-item border rounded-3 p-3 mb-3 position-relative" data-pihak="2" data-index="0">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    <label class="small text-muted mb-1 d-block">NUP</label>
                    <input type="text" name="pihak[2][penanggung_jawab_pjs][0][nip]" class="form-control form-control-m" placeholder="Masukkan NUP (opsional)">
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4 mb-3 mb-md-0">
