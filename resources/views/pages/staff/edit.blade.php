...
@section('title', 'Edit Staff - SIM Kerjasama UIS')
          ...
          <div class="card-body px-4 py-4">
            ...
            <div class="row mb-3">
              <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input type="text" name="nama_staff" id="nama_staff" class="form-control form-control-m" placeholder="Masukkan Nama" required value="{{ old('nama_staff', $staff->nama_staff) }}">
              </div>
              <div class="col-md-6">
                <label for="nup" class="small text-muted mb-1 d-block">NUP</label>
                <input type="text" name="nup" id="nup" class="form-control form-control-m" placeholder="Masukkan NUP (opsional)" value="{{ old('nup', $staff->nup) }}">
              </div>
            </div>
            ...
            <div class="row mb-3">
              <div class="col-md-4 mb-3 mb-md-0">
                ...
                <input type="text" name="jabatan" id="jabatan" class="form-control form-control-m" placeholder="Masukkan Jabatan (opsional)" value="{{ old('jabatan', $staff->jabatan) }}">
              </div>
              <div class="col-md-4 mb-3 mb-md-0">
                <label for="email" class="small text-muted mb-1 d-block">Email</label>
                <input type="email" name="email" id="email" class="form-control form-control-m" placeholder="Masukkan Email (opsional)" value="{{ old('email', $staff->email) }}">
              </div>
              <div class="col-md-4">
                <label for="nomor_hp" class="small text-muted mb-1 d-block">Nomor Telepon</label>
                <input type="text" name="nomor_hp" id="nomor_hp" class="form-control form-control-m" placeholder="Masukkan Nomor Telepon (opsional)" value="{{ old('nomor_hp', $staff->nomor_hp) }}">
              </div>
            </div>
              ...
              <div class="col-md-6 mb-3 mb-md-0">
                ...
                <select name="unit_kerja_id" id="unit_kerja_id" class="form-select form-control-m">
                  ...
                  @foreach($unitKerjas as $uk)
                    <option value="{{ $uk->id }}" {{ old('unit_kerja_id', $staff->unit_kerja_id) == $uk->id ? 'selected' : '' }}>{{ $uk->nama_unit_kerja }}</option>
                  @endforeach
                </select>
              </div>
              <div class="col-md-6">
                ...
                <select name="status" id="status" class="form-select form-control-m" required>
                  ...
                  <option value="Tidak Aktif" {{ old('status', $staff->status) == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                </select>
              </div>
            </div>
            ...
            <div class="mb-2">
              ...
              <textarea name="alamat" id="alamat" class="form-control form-control-m" rows="2" placeholder="Masukkan Alamat (opsional)">{{ old('alamat', $staff->alamat) }}</textarea>
            </div>
