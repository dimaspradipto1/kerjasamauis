...
@section('title', 'Tambah Sasaran Kinerja - SIM Kerjasama UIS')

@section('content')
<div class="pagetitle mb-3">
  <h1>Tambah Sasaran Kinerja</h1>
  <nav>
    <ol class="breadcrumb">
...
<section class="section">
  <div class="row">
    <div class="col-12">
      ...
      <form action="{{ route('sasaran-kinerja.store') }}" method="POST" id="formSasaran">
        @csrf
        ...
        <div class="card shadow-sm border-0 mb-4">
          ...
          <div class="card-body px-4 py-4">
            ...
            <div class="mb-4">
              ...
              <input
                type="text"
                name="sasaran_kinerja"
                id="sasaran_kinerja"
                class="form-control form-control-sk @error('sasaran_kinerja') is-invalid @enderror"
                value="{{ old('sasaran_kinerja') }}"
                placeholder="Masukkan Sasaran Kinerja"
                required
              >
              @error('sasaran_kinerja')
        ...
        <div class="card shadow-sm border-0 mb-4">
          ...
          <div class="card-body px-4 py-4">
            ...
            <div id="indikator-wrapper">
              {{-- Indikator pertama --}}
              <div class="indikator-item border rounded-3 p-4 mb-3 position-relative" data-index="0">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h6 class="fw-bold mb-0 indikator-title">Indikator 1</h6>
                  <button type="button" class="btn btn-sm btn-outline-danger btn-remove-indikator d-none" title="Hapus indikator ini">
                ...
                <div class="mb-3">
                  <label class="form-label fw-medium">
                    Indikator <span class="text-danger">*</span>
                  </label>
                  <input
                    type="text"
                    name="indikator[0][indikator_sasaran]"
                    class="form-control form-control-sk @error('indikator.0.indikator_sasaran') is-invalid @enderror"
                    placeholder="Masukkan Indikator"
                    value="{{ old('indikator.0.indikator_sasaran') }}"
                    required
                  >
                  @error('indikator.0.indikator_sasaran')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="mb-3">
                  ...
                  <textarea
                    name="indikator[0][keterangan]"
                    class="form-control form-control-sk"
                    rows="3"
                    placeholder="Masukkan Keterangan (opsional)"
                  >{{ old('indikator.0.keterangan') }}</textarea>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-1">
                    ...
                    <input
                      type="number"
                      name="indikator[0][volume]"
                      class="form-control form-control-sk"
                      placeholder="Masukkan Volume (opsional)"
                      value="{{ old('indikator.0.volume') }}"
                      min="0"
                    >
                  </div>
                  <div class="col-md-6 mb-1">
                    ...
                    <input
                      type="text"
                      name="indikator[0][satuan]"
                      class="form-control form-control-sk"
                      placeholder="Masukkan Satuan (opsional)"
                      value="{{ old('indikator.0.satuan') }}"
                    >
                  </div>
                </div>
              </div>
...
<script>
    ...
    return `
      <div class="indikator-item border rounded-3 p-4 mb-3 position-relative" data-index="${index}">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <button type="button" class="btn btn-sm btn-outline-danger btn-remove-indikator" title="Hapus indikator ini">
            <i class="bi bi-x-lg"></i>
          </button>
        </div>
  ...
  function renumberTitles() {
    document.querySelectorAll('#indikator-wrapper .indikator-title').forEach((el, i) => {
      el.textContent = 'Indikator ' + (i + 1);
    });
    // Show remove button only when more than 1 indikator
    const items = document.querySelectorAll('#indikator-wrapper .indikator-item');
    items.forEach(item => {
      const btn = item.querySelector('.btn-remove-indikator');
  ...
  document.getElementById('btnTambahIndikator').addEventListener('click', function () {
    ...
    wrapper.insertAdjacentHTML('beforeend', makeIndikatorBlock(indikatorCount));
    indikatorCount++;
    renumberTitles();
  });
