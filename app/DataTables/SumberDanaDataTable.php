...
class SumberDanaDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->orderBy('nama_sumber_dana', 'asc');
    }

    public function html(): HtmlBuilder
    {
        return $this->builder()
            ->setTableId('sumber-dana-table')
    ...
    {
        return 'SumberDana_' . date('YmdHis');
    }
}
